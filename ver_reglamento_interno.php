...
<div class="row">
<div class="col-md-12">
		<h2 align="center"><font color ="#0000FF">Reglamento Interno</font></h2>
...
<div class="alert alert-info" role="alert" align="right">
  ...
  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
						...
						<form role="form" method="post" action="php/agregar_regla_interna.php">
	...
	<?php include "php/tabla_reglamento_interno.php"; ?>
</div>
</div>
</div>
