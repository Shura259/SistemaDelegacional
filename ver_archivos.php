...
<html>
                        ...
                        if (respuesta) {
                            ...
                            for (var i = 0; i < respuesta.length; i++) {
                                if (respuesta[i] != undefined) {
                                    html += '<div class="row"> <span class="col-lg-8"> ' + respuesta[i] + ' </span> <div class="" align="center"> <a class="eliminar_archivo btn btn-info" href="javascript:void(0);"> Ver Documento </a> </div> </div> <hr />';
                                }
                            }
	...
	<?php include "php/navbar.php"; ?><br><br><br><br><br><br>
        <div class="container">
			<div class="row">
				<div class="col-md-12">
		<h1 align="center"><font color ="#0000FF">Normateca</font></h1>
		...
		<div class="alert alert-info" role="alert" align="right">
            ...
            <form action="javascript:void(0);">
                ...
                <div class="row">
                    <div class="col-lg-2">
                        <input type="submit" id="boton_subir" value="Subir Documento" class="btn btn-success" />
                    </div>
                    <div class="col-lg-2">
